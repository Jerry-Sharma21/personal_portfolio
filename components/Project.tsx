...
const Project: React.FC<IProjectProps> = props => {
  ...
  return (
    ...
    >
      <section
        className="bg-gray-100 mx-w-[42rem] border border-black/5 overflow-hidden sm:pr-8
      relative sm:h-[20rem] mb-3 sm:mb-8 last:mb-0 sm:group-even:pl-8 hover:bg-gray-200 transition
